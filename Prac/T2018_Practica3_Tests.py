...
from T2018_Practica3_Skeleton import *
...
class Test3_3_ZkpCheaterProverB1ComputeC(unittest.TestCase):
    ...
    def test_1(self):
        ...
        # Python 2:
        # self.assertEqual(prover.compute_c(), 17509)
        # self.assertEqual(prover.r, 23075)
...
if __name__ == '__main__':
    ...
    test_classes_to_run = [Test1_1_ElGamalKeyGen, Test1_2_ElGamalSign, Test1_3_ElGamalVerify, Test1_4_ElGamalExtractPrivKey,
                           Test2_1_0_ZkpProverInit, Test2_1_ZkpProverComputeC, Test2_2_ZkpProverComputeH,
                           Test2_3_0_kpVerifierInit, Test2_3_ZkpVerifierChooseb, Test2_4_ZkpVerifierVerify, Test2_5_Challenge,
